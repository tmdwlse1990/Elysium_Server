...
enum e_aura_special : uint32 {
	...
	AURA_SPECIAL_HIDE_DISAPPEAR = 0x0001	// When the character uses hidden skills, this effect will disappear (this effect will need to be redrawn after the character is restored to display)
};

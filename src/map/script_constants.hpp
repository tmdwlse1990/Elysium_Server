...
/// @APIHOOK_START(EFST_CONST)
	...
	// Instance Setting
	export_constant(EFST_INSTANCE_RESIST_PENALTY);
	export_constant(EFST_INSTANCE_EXP_BONUS);
	export_constant(EFST_INSTANCE_DROP_BONUS);
/// @APIHOOK_END
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant_npc(JT_EP20_COPO);
	...
	export_constant_npc(JT_EP21_NPC_TRIS);
	...
	export_constant_npc(JT_EP21_SEAWIND);
	...
	export_constant_npc(JT_CP_VIOLEN);
	...
	export_constant_npc(JT_EP21_YOR_TAN_H);
	export_constant_npc(JT_EP21_MD_BOX2);
	export_constant_npc(JT_EP21_YORTUS_A_H);
	export_constant_npc(JT_EP21_YORTUS_B_H);
	export_constant_npc(JT_EP21_YORDOS_C_H);
	export_constant_npc(JT_EP21_YORDOS_B_H);
	export_constant_npc(JT_EP21_YORDOS_A_H);
	export_constant_npc(JT_EP21_YORMI_A_H);
	export_constant_npc(JT_EP21_YORMI_B_H);
	export_constant_npc(JT_EP21_YOSCOPUS_A_H);
	export_constant_npc(JT_EP21_YOSCOPUS_B_H);
	export_constant_npc(JT_EP21_B_YORTUS_A_H);
	export_constant_npc(JT_EP21_B_YORTUS_B_H);
	export_constant_npc(JT_2501_EV_MATJALAL);
	export_constant_npc(JT_2501_EV_ACARI);
	export_constant_npc(JT_E_LEADER_SHEEP);
	export_constant_npc(JT_E_WINTER_SAVAGE);
	export_constant_npc(JT_MANDURING);
	export_constant_npc(JT_KINGMANDURING);
	export_constant_npc(JT_E_WINTER_KEEPER);
	export_constant_npc(JT_TATSI);
	export_constant_npc(JT_G_TATSI);
	export_constant_npc(JT_CP_TATSI);
	export_constant_npc(JT_GUERRERO);
	export_constant_npc(JT_HANOM);
	export_constant_npc(JT_SIRENA);
	export_constant_npc(JT_DIOSA);
	export_constant_npc(JT_PESKA);
	export_constant_npc(JT_CP_GUERRERO);
	export_constant_npc(JT_CP_HANOM);
	export_constant_npc(JT_CP_SIRENA);
	export_constant_npc(JT_CP_DIOSA);
	export_constant_npc(JT_CH1_YGGRING);
	export_constant_npc(JT_CH1_LEAFEING);
	export_constant_npc(JT_CH1_CHARCOARING);
	export_constant_npc(JT_CH1_VULRING);
	export_constant_npc(JT_CH1_FIRELOOP);
	export_constant_npc(JT_CH1_FIRAFFLESIA);
	export_constant_npc(JT_CH1_VOLIMPET);
	export_constant_npc(JT_CH1_FIRE_FLOWER);
	export_constant_npc(JT_CH1_PEEPING);
	export_constant_npc(JT_CH1_SILK_FROG);
	export_constant_npc(JT_CH1_SILK_SNAIL);
	export_constant_npc(JT_CH1_EX_ROBOT);
	export_constant_npc(JT_CH1_REPAIR_ROBOT);
	export_constant_npc(JT_CH1_DIMIC_1);
	export_constant_npc(JT_CH1_DIMIC_2);
	export_constant_npc(JT_CH1_DIMIC_3);
	export_constant_npc(JT_CH1_DIMIC_4);
	export_constant_npc(JT_CH1_IMMORTAL_CORPS1);
	export_constant_npc(JT_CH1_IMMORTAL_CORPS2);
	export_constant_npc(JT_CH1_IMMORTAL_CORPS3);
	export_constant_npc(JT_CH1_NYAISE);
	export_constant_npc(JT_CH1_SHADOW_JAILER);
	export_constant_npc(JT_CH1_TULIP);
	export_constant_npc(JT_CH1_CALENDULA);
	export_constant_npc(JT_CH1_SCABIOSA);
	export_constant_npc(JT_CH1_LOBELIA);
	export_constant_npc(JT_CH1_MYOSOTIS);
	export_constant_npc(JT_CH1_ANEMONE);
	export_constant_npc(JT_CH1_SKOGL);
	export_constant_npc(JT_CH1_FRUS);
	export_constant_npc(JT_CH1_LISTENER);
	export_constant_npc(JT_CH1_IMMORTAL_OFFICER1);
	export_constant_npc(JT_CH1_IMMORTAL_OFFICER2);
	export_constant_npc(JT_CH1_TOXIT);
	export_constant_npc(JT_CP_CH1_TOXIT);
	export_constant_npc(JT_CH1_LUNARINA);
	export_constant_npc(JT_CP_CH1_LUNARINA);
	export_constant_npc(JT_CH1_BLOODY_SLASHER);
	export_constant_npc(JT_CP_CH1_BLOODY_SLASHER);
	export_constant_npc(JT_CH1_SHADIEST);
	export_constant_npc(JT_CP_CH1_SHADIEST);
	export_constant_npc(JT_CH1_SUCCUBUS);
	export_constant_npc(JT_CP_CH1_SUCCUBUS);
	export_constant_npc(JT_CH1_INCCUBUS);
	export_constant_npc(JT_CP_CH1_INCCUBUS);
	export_constant_npc(JT_CH1_ABYSS_KNIGHT);
	export_constant_npc(JT_CP_CH1_ABYSS_KNIGHT);
	export_constant_npc(JT_G_CH1_FIRELOOP);
	export_constant_npc(JT_G_CH1_VOLIMPET);
	export_constant_npc(JT_G_CH1_MYOSOTIS);
	export_constant_npc(JT_G_CH1_ANEMONE);
	export_constant_npc(JT_CH1_BULGASARI);
	export_constant_npc(JT_CH1_GLUTTO);
	export_constant_npc(JT_CH1_MD_HEMEL_N);
	export_constant_npc(JT_CH1_MD_HEMEL);
	export_constant_npc(JT_CH1_MD_AMDARAIS);
	export_constant_npc(JT_CH1_MD_VESSEL);
	...
	export_constant(HAT_EF_C_KYEL_HYRE_ULTI2);
	export_constant(HAT_EF_GOLDENRESONATETAEGO);
	export_constant(HAT_EF_MN_SPOOKY_SHADOWS);
	export_constant(HAT_EF_FR_AURA_SOUL1);
	export_constant(HAT_EF_FR_AURA_SOUL2);
	export_constant(HAT_EF_FR_AURA_SOUL3);
	export_constant(HAT_EF_FR_AURA_SOUL4);
	export_constant(HAT_EF_FR_AURA_RAINBOW1);
	export_constant(HAT_EF_FR_AURA_RAINBOW2);
	export_constant(HAT_EF_FR_AURA_RAINBOW3);
	export_constant(HAT_EF_FR_AURA_RAINBOW4);
	export_constant(HAT_EF_FR_ARROW99_BLUE);
	export_constant(HAT_EF_FR_ARROW99_CIAN);
	export_constant(HAT_EF_FR_ARROW99_GREEN);
	export_constant(HAT_EF_FR_ARROW99_ORANGE);
	export_constant(HAT_EF_FR_ARROW99_PINK);
	export_constant(HAT_EF_FR_ARROW99_PURPLE);
	export_constant(HAT_EF_FR_ARROW99_RED);
	export_constant(HAT_EF_FR_ARROW99_WHITE);
	export_constant(HAT_EF_FR_ARROW99_YELLOW);
	export_constant(HAT_EF_FR_AURA_BUBBLEFUN);
	export_constant(HAT_EF_FR_CATPLANET_BLUE);
	export_constant(HAT_EF_FR_CATPLANET_DARK);
	export_constant(HAT_EF_FR_CIRCLE_BLUE);
	export_constant(HAT_EF_FR_CIRCLE_BLUE2);
	export_constant(HAT_EF_FR_CIRCLE_GREEN);
	export_constant(HAT_EF_FR_CIRCLE_MIST);
	export_constant(HAT_EF_FR_CIRCLE_ORANGE);
	export_constant(HAT_EF_FR_CIRCLE_PINK);
	export_constant(HAT_EF_FR_CIRCLE_PURPLE);
	export_constant(HAT_EF_FR_CIRCLE_RED);
	export_constant(HAT_EF_FR_CIRCLE_YELLOW);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_BLUE);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_GREEN);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_ORANGE);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_PINK);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_PURPLE);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_RED);
	export_constant(HAT_EF_FR_CLOUD_FRIEND_YELLOW);
	export_constant(HAT_EF_FR_AURA_COSMIC);
	export_constant(HAT_EF_FR_DARKDEVIL_BLUE);
	export_constant(HAT_EF_FR_DARKDEVIL_GREEN);
	export_constant(HAT_EF_FR_DARKDEVIL_ORANGE);
	export_constant(HAT_EF_FR_DARKDEVIL_PINK);
	export_constant(HAT_EF_FR_DARKDEVIL_PURPLE);
	export_constant(HAT_EF_FR_DARKDEVIL_RED);
	export_constant(HAT_EF_FR_DARKDEVIL_YELLOW);
	export_constant(HAT_EF_FR_FLOWER_BLUE);
	export_constant(HAT_EF_FR_FLOWER_GREEN);
	export_constant(HAT_EF_FR_FLOWER_ORANGE);
	export_constant(HAT_EF_FR_FLOWER_PINK);
	export_constant(HAT_EF_FR_FLOWER_PURPLE);
	export_constant(HAT_EF_FR_FLOWER_RED);
	export_constant(HAT_EF_FR_FLOWER_YELLOW);
	export_constant(HAT_EF_FR_GALACTIC_BLUE);
	export_constant(HAT_EF_FR_GALACTIC_GREEN);
	export_constant(HAT_EF_FR_GALACTIC_ORANGE);
	export_constant(HAT_EF_FR_GALACTIC_PINK);
	export_constant(HAT_EF_FR_GALACTIC_PURPLE);
	export_constant(HAT_EF_FR_GALACTIC_RED);
	export_constant(HAT_EF_FR_GALACTIC_YELLOW);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_BLUE);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_GREEN);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_ORANGE);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_PINK);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_PURPLE);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_RED);
	export_constant(HAT_EF_FR_GLOBCHRISTMAS_YELLOW);
	export_constant(HAT_EF_FR_GLOBSNOW_BLUE);
	export_constant(HAT_EF_FR_GLOBSNOW_GREEN);
	export_constant(HAT_EF_FR_GLOBSNOW_ORANGE);
	export_constant(HAT_EF_FR_GLOBSNOW_PINK);
	export_constant(HAT_EF_FR_GLOBSNOW_PURPLE);
	export_constant(HAT_EF_FR_GLOBSNOW_RED);
	export_constant(HAT_EF_FR_GLOBSNOW_YELLO);
	export_constant(HAT_EF_FR_HEARTY_BLUE);
	export_constant(HAT_EF_FR_HEARTY_GREEN);
	export_constant(HAT_EF_FR_HEARTY_ORANGE);
	export_constant(HAT_EF_FR_HEARTY_ORIGINAL);
	export_constant(HAT_EF_FR_HEARTY_PINK);
	export_constant(HAT_EF_FR_HEARTY_PURPLE);
	export_constant(HAT_EF_FR_HEARTY_RED);
	export_constant(HAT_EF_FR_HEARTY_YELLOW);
	export_constant(HAT_EF_FR_HORN_BLUE);
	export_constant(HAT_EF_FR_HORN_GREEN);
	export_constant(HAT_EF_FR_HORN_ORANGE);
	export_constant(HAT_EF_FR_HORN_ORIGINAL);
	export_constant(HAT_EF_FR_HORN_PINK);
	export_constant(HAT_EF_FR_HORN_PURPLE);
	export_constant(HAT_EF_FR_HORN_RED);
	export_constant(HAT_EF_FR_HORN_WHITE);
	export_constant(HAT_EF_FR_HORN_YELLOW);
	export_constant(HAT_EF_FR_AURA_KINGZOAN);
	export_constant(HAT_EF_FR_AURA_LUNARGROUND);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_BLUE);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_GREEN);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_ORANGE);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_PINK);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_PURPLE);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_RED);
	export_constant(HAT_EF_FR_MAGIC_CIRCLE_YELLOW);
	export_constant(HAT_EF_FR_MAGIC_STATE2_BLUE);
	export_constant(HAT_EF_FR_MAGIC_STATE2_GREEN);
	export_constant(HAT_EF_FR_MAGIC_STATE2_ORANGE);
	export_constant(HAT_EF_FR_MAGIC_STATE2_PINK);
	export_constant(HAT_EF_FR_MAGIC_STATE2_PURPLE);
	export_constant(HAT_EF_FR_MAGIC_STATE2_RED);
	export_constant(HAT_EF_FR_MAGIC_STATE2_YELLOW);
	export_constant(HAT_EF_FR_MIR4_BLUE);
	export_constant(HAT_EF_FR_MIR4_GREEN);
	export_constant(HAT_EF_FR_MIR4_NORMAL);
	export_constant(HAT_EF_FR_MIR4_ORANGE);
	export_constant(HAT_EF_FR_MIR4_PINK);
	export_constant(HAT_EF_FR_MIR4_PURPLE);
	export_constant(HAT_EF_FR_MIR4_RED);
	export_constant(HAT_EF_FR_MIR4_YELLOW);
	export_constant(HAT_EF_FR_NUCLEAR_BLUE2);
	export_constant(HAT_EF_FR_NUCLEAR_GREEN2);
	export_constant(HAT_EF_FR_NUCLEAR_ORANGE2);
	export_constant(HAT_EF_FR_NUCLEAR_PINK2);
	export_constant(HAT_EF_FR_NUCLEAR_PURPLE2);
	export_constant(HAT_EF_FR_NUCLEAR_RED2);
	export_constant(HAT_EF_FR_NUCLEAR_YELLOW2);
	export_constant(HAT_EF_FR_PINKFAIRY_BLUE);
	export_constant(HAT_EF_FR_PINKFAIRY_GREEN);
	export_constant(HAT_EF_FR_PINKFAIRY_ORANGE);
	export_constant(HAT_EF_FR_PINKFAIRY_ORIGINAL);
	export_constant(HAT_EF_FR_PINKFAIRY_PINK);
	export_constant(HAT_EF_FR_PINKFAIRY_PURPLE);
	export_constant(HAT_EF_FR_PINKFAIRY_RED);
	export_constant(HAT_EF_FR_PINKFAIRY_YELLOW);
	export_constant(HAT_EF_FR_POISONMAX_BLUE);
	export_constant(HAT_EF_FR_POISONMAX_GREEN);
	export_constant(HAT_EF_FR_POISONMAX_ORANGE);
	export_constant(HAT_EF_FR_POISONMAX_PINK);
	export_constant(HAT_EF_FR_POISONMAX_PURPLE);
	export_constant(HAT_EF_FR_POISONMAX_RED);
	export_constant(HAT_EF_FR_POISONMAX_WHITE);
	export_constant(HAT_EF_FR_POISONMAX_YELLOW);
	export_constant(HAT_EF_FR_SAIAJ_BLUE);
	export_constant(HAT_EF_FR_SAIAJ_GREEN);
	export_constant(HAT_EF_FR_SAIAJ_LAVA);
	export_constant(HAT_EF_FR_SAIAJ_PINK);
	export_constant(HAT_EF_FR_SAIAJ_RED);
	export_constant(HAT_EF_FR_SEVEN_BLUE);
	export_constant(HAT_EF_FR_SEVEN_GREEN);
	export_constant(HAT_EF_FR_SEVEN_ORANGE);
	export_constant(HAT_EF_FR_SEVEN_PINK);
	export_constant(HAT_EF_FR_SEVEN_PURPLE);
	export_constant(HAT_EF_FR_SEVEN_RED);
	export_constant(HAT_EF_FR_SEVEN_YELLOW);
	export_constant(HAT_EF_FR_SILVERSHIELD_BLUE);
	export_constant(HAT_EF_FR_SILVERSHIELD_GREEN);
	export_constant(HAT_EF_FR_SILVERSHIELD_ORANGE);
	export_constant(HAT_EF_FR_SILVERSHIELD_PINK);
	export_constant(HAT_EF_FR_SILVERSHIELD_PURPLE);
	export_constant(HAT_EF_FR_SILVERSHIELD_RED);
	export_constant(HAT_EF_FR_SILVERSHIELD_YELLOW);
	export_constant(HAT_EF_FR_SPARKLE_BLUE);
	export_constant(HAT_EF_FR_SPARKLE_GREEN);
	export_constant(HAT_EF_FR_SPARKLE_ORANGE);
	export_constant(HAT_EF_FR_SPARKLE_PINK);
	export_constant(HAT_EF_FR_SPARKLE_PURPLE);
	export_constant(HAT_EF_FR_SPARKLE_RED);
	export_constant(HAT_EF_FR_SPARKLE_YELLOW);
	export_constant(HAT_EF_FR_TWIST_BLUE);
	export_constant(HAT_EF_FR_TWIST_GREEN);
	export_constant(HAT_EF_FR_TWIST_ORANGE);
	export_constant(HAT_EF_FR_TWIST_PINK);
	export_constant(HAT_EF_FR_TWIST_PURPLE);
	export_constant(HAT_EF_FR_TWIST_RED);
	export_constant(HAT_EF_FR_TWIST_WHITE);
	export_constant(HAT_EF_FR_TWIST_YELLOW);
	export_constant(HAT_EF_FR_AURAMOON_BLACK);
	export_constant(HAT_EF_FR_AURAMOON_BLUE);
	export_constant(HAT_EF_FR_AURAMOON_GREEN);
	export_constant(HAT_EF_FR_AURAMOON_ORANGE);
	export_constant(HAT_EF_FR_AURAMOON_ORIGINAL);
	export_constant(HAT_EF_FR_AURAMOON_OST);
	export_constant(HAT_EF_FR_AURAMOON_OST2);
	export_constant(HAT_EF_FR_AURAMOON_PINK);
	export_constant(HAT_EF_FR_AURAMOON_PURPLE);
	export_constant(HAT_EF_FR_AURAMOON_RED);
	export_constant(HAT_EF_FR_AURAMOON_WHITE);
	export_constant(HAT_EF_FR_AURAMOON_YELLOW);
	export_constant(HAT_EF_FR_AURORABOREAL);
	export_constant(HAT_EF_FR_BCIRCLE_BLUE);
	export_constant(HAT_EF_FR_BCIRCLE_GREEN);
	export_constant(HAT_EF_FR_BCIRCLE_ORANGE);
	export_constant(HAT_EF_FR_BCIRCLE_PINK);
	export_constant(HAT_EF_FR_BCIRCLE_PURPLE);
	export_constant(HAT_EF_FR_BCIRCLE_RED);
	export_constant(HAT_EF_FR_BCIRCLE_YELLOW);
	export_constant(HAT_EF_FR_BLADE_BLUE);
	export_constant(HAT_EF_FR_BLADE_CIAN);
	export_constant(HAT_EF_FR_BLADE_GREEN);
	export_constant(HAT_EF_FR_BLADE_ORANGE);
	export_constant(HAT_EF_FR_BLADE_PINK);
	export_constant(HAT_EF_FR_BLADE_PURPLE);
	export_constant(HAT_EF_FR_BLADE_RED);
	export_constant(HAT_EF_FR_BLADE_YELLOW);
	export_constant(HAT_EF_FR_BT_EXPLOSION);
	export_constant(HAT_EF_FR_BT_IMPLOSION);
	export_constant(HAT_EF_FR_CONFUSION);
	export_constant(HAT_EF_FR_CYBERPORTAL_BLUE);
	export_constant(HAT_EF_FR_CYBERPORTAL_GREEN);
	export_constant(HAT_EF_FR_CYBERPORTAL_ORANGE);
	export_constant(HAT_EF_FR_CYBERPORTAL_PINK);
	export_constant(HAT_EF_FR_CYBERPORTAL_PURPLE);
	export_constant(HAT_EF_FR_CYBERPORTAL_RED);
	export_constant(HAT_EF_FR_CYBERPORTAL_YELLOW);
	export_constant(HAT_EF_FR_DARKSHADOW_BLUE_S);
	export_constant(HAT_EF_FR_DARKSHADOW_GREEN_S);
	export_constant(HAT_EF_FR_DARKSHADOW_ORANGE_S);
	export_constant(HAT_EF_FR_DARKSHADOW_PINK_S);
	export_constant(HAT_EF_FR_DARKSHADOW_PURPLE_S);
	export_constant(HAT_EF_FR_DARKSHADOW_RED_S);
	export_constant(HAT_EF_FR_DARKSHADOW_YELLOW_S);
	export_constant(HAT_EF_FR_DARKSHADOW_BLUE);
	export_constant(HAT_EF_FR_DARKSHADOW_GREEN);
	export_constant(HAT_EF_FR_DARKSHADOW_ORANGE);
	export_constant(HAT_EF_FR_DARKSHADOW_PINK);
	export_constant(HAT_EF_FR_DARKSHADOW_PURPLE);
	export_constant(HAT_EF_FR_DARKSHADOW_RED);
	export_constant(HAT_EF_FR_DARKSHADOW_YELLOW);
	export_constant(HAT_EF_FR_ELEMENTARY_BLUE);
	export_constant(HAT_EF_FR_ELEMENTARY_GREEN);
	export_constant(HAT_EF_FR_ELEMENTARY_ORANGE);
	export_constant(HAT_EF_FR_ELEMENTARY_PINK);
	export_constant(HAT_EF_FR_ELEMENTARY_PURPLE);
	export_constant(HAT_EF_FR_ELEMENTARY_RED);
	export_constant(HAT_EF_FR_ELEMENTARY_YELLOW);
	export_constant(HAT_EF_FR_FIRESOUL_BLUE);
	export_constant(HAT_EF_FR_FIRESOUL_GREEN);
	export_constant(HAT_EF_FR_FIRESOUL_ORANGE);
	export_constant(HAT_EF_FR_FIRESOUL_PINK);
	export_constant(HAT_EF_FR_FIRESOUL_PURPLE);
	export_constant(HAT_EF_FR_FIRESOUL_RED);
	export_constant(HAT_EF_FR_FIRESOUL_YELLOW);
	export_constant(HAT_EF_FR_FLOWERB99_BLUE);
	export_constant(HAT_EF_FR_FLOWERB99_GREEN);
	export_constant(HAT_EF_FR_FLOWERB99_ORANGE);
	export_constant(HAT_EF_FR_FLOWERB99_PINK);
	export_constant(HAT_EF_FR_FLOWERB99_PURPLE);
	export_constant(HAT_EF_FR_FLOWERB99_RED);
	export_constant(HAT_EF_FR_FLOWERB99_YELLOW);
	export_constant(HAT_EF_FR_VORTEX_BLUE);
	export_constant(HAT_EF_FR_VORTEX_GREEN);
	export_constant(HAT_EF_FR_VORTEX_ORANGE);
	export_constant(HAT_EF_FR_VORTEX_PINK);
	export_constant(HAT_EF_FR_VORTEX_PURPLE);
	export_constant(HAT_EF_FR_VORTEX_RED);
	export_constant(HAT_EF_FR_VORTEX_YELLOW);
	export_constant(HAT_EF_FR_GAYACIRCB99_BLUE);
	export_constant(HAT_EF_FR_GAYACIRCB99_GREEN);
	export_constant(HAT_EF_FR_GAYACIRCB99_ORANGE);
	export_constant(HAT_EF_FR_GAYACIRCB99_PINK);
	export_constant(HAT_EF_FR_GAYACIRCB99_PURPLE);
	export_constant(HAT_EF_FR_GAYACIRCB99_RED);
	export_constant(HAT_EF_FR_GAYACIRCB99_YELLOW);
	export_constant(HAT_EF_FR_GLOB2CHRIST);
	export_constant(HAT_EF_FR_HALLOW_G);
	export_constant(HAT_EF_FR_HEAD_HELP);
	export_constant(HAT_EF_FR_HELLKING_AURA1);
	export_constant(HAT_EF_FR_HELLKING_AURA2);
	export_constant(HAT_EF_FR_HYPERX_BLUE);
	export_constant(HAT_EF_FR_HYPERX_GREEN);
	export_constant(HAT_EF_FR_HYPERX_ORANGE);
	export_constant(HAT_EF_FR_HYPERX_PINK);
	export_constant(HAT_EF_FR_HYPERX_PURPLE);
	export_constant(HAT_EF_FR_HYPERX_RED);
	export_constant(HAT_EF_FR_HYPERX_YELLOW);
	export_constant(HAT_EF_FR_IMPERATOR_BLUE);
	export_constant(HAT_EF_FR_IMPERATOR_GREEN);
	export_constant(HAT_EF_FR_IMPERATOR_ORANGE);
	export_constant(HAT_EF_FR_IMPERATOR_ORIGINAL);
	export_constant(HAT_EF_FR_IMPERATOR_PINK);
	export_constant(HAT_EF_FR_IMPERATOR_PURPLE);
	export_constant(HAT_EF_FR_IMPERATOR_RED);
	export_constant(HAT_EF_FR_IMPERATOR_YELLOW);
	export_constant(HAT_EF_FR_KAYOKEN_BLUE);
	export_constant(HAT_EF_FR_KAYOKEN_GREEN);
	export_constant(HAT_EF_FR_KAYOKEN_ORANGE);
	export_constant(HAT_EF_FR_KAYOKEN_PINK);
	export_constant(HAT_EF_FR_KAYOKEN_PURPLE);
	export_constant(HAT_EF_FR_KAYOKEN_RED);
	export_constant(HAT_EF_FR_KAYOKEN_YELLOW);
	export_constant(HAT_EF_FR_LOVEISLAND);
	export_constant(HAT_EF_FR_NINJA_BLUE);
	export_constant(HAT_EF_FR_NINJA_GREEN);
	export_constant(HAT_EF_FR_NINJA_ORANGE);
	export_constant(HAT_EF_FR_NINJA_PINK);
	export_constant(HAT_EF_FR_NINJA_PURPLE);
	export_constant(HAT_EF_FR_NINJA_RED);
	export_constant(HAT_EF_FR_NINJA_YELLOW);
	export_constant(HAT_EF_FR_OCEAN_G);
	export_constant(HAT_EF_FR_ONEPIECE);
	export_constant(HAT_EF_FR_PARTICLES_B_BLUE);
	export_constant(HAT_EF_FR_PARTICLES_B_GREEN);
	export_constant(HAT_EF_FR_PARTICLES_B_ORANGE);
	export_constant(HAT_EF_FR_PARTICLES_B_PINK);
	export_constant(HAT_EF_FR_PARTICLES_B_PURPLE);
	export_constant(HAT_EF_FR_PARTICLES_B_RED);
	export_constant(HAT_EF_FR_PARTICLES_B_YELLOW);
	export_constant(HAT_EF_FR_SNOWGROUND);
	export_constant(HAT_EF_FR_STAR99_BLUE);
	export_constant(HAT_EF_FR_STAR99_BLUE2);
	export_constant(HAT_EF_FR_STAR99_GREEN);
	export_constant(HAT_EF_FR_STAR99_ORANGE);
	export_constant(HAT_EF_FR_STAR99_PINK);
	export_constant(HAT_EF_FR_STAR99_PURPLE);
	export_constant(HAT_EF_FR_STAR99_RED);
	export_constant(HAT_EF_FR_STAR99_YELLOW);
	export_constant(HAT_EF_FR_STREAMER_BLUE);
	export_constant(HAT_EF_FR_STREAMER_GREEN);
	export_constant(HAT_EF_FR_STREAMER_ORANGE);
	export_constant(HAT_EF_FR_STREAMER_PINK);
	export_constant(HAT_EF_FR_STREAMER_PURPLE);
	export_constant(HAT_EF_FR_STREAMER_RED);
	export_constant(HAT_EF_FR_STREAMER_YELLOW);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_BLUE);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_GREEN);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_ORANGE);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_ORIGINAL);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_PINK);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_PURPLE);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_RED);
	export_constant(HAT_EF_FR_THUNDERSPIRIT_YELLOW);
	export_constant(HAT_EF_FR_TIMEGUARD_BLUE);
	export_constant(HAT_EF_FR_TIMEGUARD_GREEN);
	export_constant(HAT_EF_FR_TIMEGUARD_NORMAL);
	export_constant(HAT_EF_FR_TIMEGUARD_ORANGE);
	export_constant(HAT_EF_FR_TIMEGUARD_PINK);
	export_constant(HAT_EF_FR_TIMEGUARD_PURPLE);
	export_constant(HAT_EF_FR_TIMEGUARD_RED);
	export_constant(HAT_EF_FR_TIMEGUARD_YELLOW);
	export_constant(HAT_EF_FR_TWISTBLU_BLUE);
	export_constant(HAT_EF_FR_TWISTBLU_GREEN);
	export_constant(HAT_EF_FR_TWISTBLU_ORANGE);
	export_constant(HAT_EF_FR_TWISTBLU_PINK);
	export_constant(HAT_EF_FR_TWISTBLU_PURPLE);
	export_constant(HAT_EF_FR_TWISTBLU_RED);
	export_constant(HAT_EF_FR_TWISTBLU_YELLOW);
